...
```{r soybean_use_share, echo = FALSE, message = FALSE, fig.align='center', out.width = "63%"}
...
.pull-right[
```{r forest_area_table, echo = F, message = F, out.width = "80%"}
forest2 <- forest %>%
  filter(entity == "World")
...
.pull-left[
```{r compare, echo = FALSE, message = FALSE, out.width = "300%", out.height= "300%"}
