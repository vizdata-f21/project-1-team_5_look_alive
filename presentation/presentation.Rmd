...
# Question One
## What countries are driving the growing of Brazil’s soybean crops? What is the relationship between soybean production and deforestation in Brazil?
...
brazil_loss %>% select(year, total_brazil_forest_loss_hectares) %>%
  ...
  ggplot() +
  geom_line(aes(year, cum_sum), size = 3, color = "#009739") +
  geom_hline(aes(yintercept = 0)) +
  geom_point(aes(year, cum_sum)) +
...
```{r echo = FALSE, message=F, fig.alt = "interpretation."}
